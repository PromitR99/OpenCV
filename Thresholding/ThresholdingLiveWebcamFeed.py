...
def main():
    ...
    windowName = ['Original', 'Binary', 'Binary Inv', 'Zero', 'Zero Inv', 'Trunc']
    ...
    while ret:
        ...
        cv2.imshow(windowName[1], o1)
        cv2.imshow(windowName[2], o2)
        cv2.imshow(windowName[3], o3)
        cv2.imshow(windowName[4], o4)
        cv2.imshow(windowName[5], o5)
        if cv2.waitKey(1) == 27:
            break
